...
```
To visualize using tensorboard, run the below command, copy the URL to your browser to view the embeddings as shown below 
```
tensorboard --logdir <path to folder yyyy-mm-dd-hh:mm created in previous step>
```
<p align="center">
  <img src="img/CMC_example.png" alt="cmc" width="48%">
</p>
