...
class Architect(object):
    ...
    def _compute_model(self, input, target, eta, network_optimizer):
        moments = {}
        loss = self.model._loss(input, target)
    ...
    def step(self, input_train, target_train, input_valid, target_valid, eta,
        ...
        if unrolled:
            self._backward_step_unrolled(input_train, target_train, input_valid,
                                         target_valid, eta, network_optimizer)
        else:
            self._backward_step(input_train, target_train, input_valid,
                                target_valid, eta, network_optimizer)
        self.optimizer.step()
